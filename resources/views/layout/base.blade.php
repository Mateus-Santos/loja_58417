...
<head>
    ...
    <script type="text/javascript" src="../js/barramentos.js"></script>
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <li @if($current == "principal") class = "active" @endif>
                    <a href="/">
                    <svg class="bi bi-house icons" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <li @if($current == "categorias") class = "active" @endif>
                    <a href="#categoriasSubmenu"  data-toggle="collapse" aria-expanded="true">
                    <svg class="bi bi-layout-text-window-reverse icons" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="collapse list-unstyled" id="categoriasSubmenu">
                        <li>
                            ...
                            <svg class="bi bi-plus icons" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li>
                            ...
                            <svg class="bi bi-card-list icons" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li>
                            ...
                            <svg class="bi bi-trash icons" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <li @if($current == "roupas") class = "active" @endif >
                    <a href="#roupasSubmenu" data-toggle="collapse" aria-expanded="true">
                    <svg class="bi bi-tag icons" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
